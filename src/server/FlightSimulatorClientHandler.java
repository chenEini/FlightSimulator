	...
	private class MyTimerTask extends TimerTask {
		...
		public void run() {
			if (clientInput != null) {
				...
				FlightSimulatorInterpreter.getData().addSimulatorBindVal("/instrumentation/heading-indicator/offset-deg", Double.parseDouble(values[13]));	
				FlightSimulatorInterpreter.getData().addSimulatorBindVal("/instrumentation/magnetic-compass/indicated-heading-deg",Double.parseDouble(values[14]));
				FlightSimulatorInterpreter.getData().addSimulatorBindVal("/instrumentation/slip-skid-ball/indicated-slip-skid",Double.parseDouble(values[15]));
				FlightSimulatorInterpreter.getData().addSimulatorBindVal("/instrumentation/turn-indicator/indicated-turn-rate",Double.parseDouble(values[16]));
				FlightSimulatorInterpreter.getData().addSimulatorBindVal("/instrumentation/vertical-speed-indicator/indicated-speed-fpm",Double.parseDouble(values[17]));
				FlightSimulatorInterpreter.getData().addSimulatorBindVal("/controls/flight/aileron", Double.parseDouble(values[18]));
				FlightSimulatorInterpreter.getData().addSimulatorBindVal("/controls/flight/elevator", Double.parseDouble(values[19]));
				FlightSimulatorInterpreter.getData().addSimulatorBindVal("/controls/flight/rudder", Double.parseDouble(values[20]));
				FlightSimulatorInterpreter.getData().addSimulatorBindVal("/controls/flight/flaps", Double.parseDouble(values[21]));
				FlightSimulatorInterpreter.getData().addSimulatorBindVal("/controls/flight/speedbrake",Double.parseDouble(values[22]));
				FlightSimulatorInterpreter.getData().addSimulatorBindVal("/controls/engines/current-engine/throttle", Double.parseDouble(values[23]));
				FlightSimulatorInterpreter.getData().addSimulatorBindVal("/engines/engine/rpm", Double.parseDouble(values[24]));
			}
		}
	}
